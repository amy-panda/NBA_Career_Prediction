...
def save_sets(X_train=None, y_train=None, X_val=None, y_val=None, X_test=None, y_test=None, set_name=None, path='D:/UTS_MDSI/ADSI/Part A/processed/New_test/'):
    ...
    path : str
        Path to the folder where the sets will be saved (default: 'D:/UTS_MDSI/ADSI/Part A/processed/New_test/')
    setname : str
...
def load_sets(set_name=None, val=False, path='D:/UTS_MDSI/ADSI/Part A/processed/New_test/'):
    ...
    ----------
    path : str
        Path to the folder where the sets are saved (default: 'D:/UTS_MDSI/ADSI/Part A/processed/New_test/')
