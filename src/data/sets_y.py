...
def save_sets(X_train=None, y_train=None, X_val=None, y_val=None, X_test=None, y_test=None, path='D:/UTS_MDSI/ADSI/Part A/processed/'):
    ...
    y_test: Numpy Array
        Target for the testing set
    path : str
        Path to the folder where the sets will be saved (default: 'D:/UTS_MDSI/ADSI/Part A/processed/')
...
def load_sets(path='D:/UTS_MDSI/ADSI/Part A/processed/', val=False):
    """Load the different locally save sets

    Parameters
    ----------
    path : str
        Path to the folder where the sets are saved (default: 'D:/UTS_MDSI/ADSI/Part A/processed/')
